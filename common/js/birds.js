(function() {
    ...
    var SCREEN_WIDTH = window.innerWidth,
        SCREEN_HEIGHT = document.getElementById("birds-container").offsetHeight,
    ...
    function onWindowResize() {
        ...
        camera.aspect = window.innerWidth / document.getElementById("birds-container").offsetHeight;
        camera.updateProjectionMatrix();

        renderer.setSize(window.innerWidth, document.getElementById("birds-container").offsetHeight);
